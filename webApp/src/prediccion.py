...
def predice(modelo, imagen, listaRectangulos, batch_size=100):
    """
    ...
    #     subarray = img_array[upper:lower, left:right]  # Submatrices usando slicing
    #     listaSubimagenes.append(subarray)
